...
def posicionar_formulario(lista_label, lista_entry, button, column=0, row=1):
    row_label = row
    row_entry = row
    ...
    for i in lista_entry:
        ...
        row_entry += 1
    button.grid(column=column+1, row=row_entry, padx=24, ipadx=16, ipady=6, sticky='e')
...
posicionar_formulario(lista_label_area, lista_entry_area, button_area)
